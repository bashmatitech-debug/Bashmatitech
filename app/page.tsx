      ...
      <main>
        ...
        <section id="community" className="section community">
          ...
          <div className="social-grid">
            <a href="https://youtube.com/@bashmatitech" target="_blank" rel="noopener noreferrer">YouTube</a>
            <a href="https://instagram.com/bashmatitech" target="_blank" rel="noopener noreferrer">Instagram</a>
            <a href="https://tiktok.com/@bashmatitech" target="_blank" rel="noopener noreferrer">TikTok</a>
            <a href="https://threads.net/@bashmatitech" target="_blank" rel="noopener noreferrer">Threads</a>
        ...
        <section id="contact" className="section contact">
          <div className="contact-box">
            ...
            <a href="mailto:Bashmatitech@gmail.com" className="btn primary">Email Bashmati Tech</a>
          </div>
        </section>
      </main>
